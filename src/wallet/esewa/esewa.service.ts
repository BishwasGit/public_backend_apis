    ...
    async initializePayment(userId: string, amount: number) {
        ...
        return {
            ...
            params: {
                ...
                success_url: `${this.configService.get('FRONTEND_URL') || 'http://localhost:5173'}/wallet/esewa/success`, 
                failure_url: `${this.configService.get('FRONTEND_URL') || 'http://localhost:5173'}/wallet/esewa/failure`,
